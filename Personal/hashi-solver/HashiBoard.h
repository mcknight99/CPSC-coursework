...
public:
    ...
    virtual bool addBridge(int row, int col, int dir) = 0;
    virtual bool removeBridge(int row, int col, int dir) = 0;
    virtual Tile getTile(int row, int col) const = 0;
    virtual int getRows() const = 0;
    virtual int getCols() const = 0;
    virtual int getIslandValue(int row, int col) const = 0;
    virtual int getIslandBridgeByDir(int row, int col, int dir) const = 0;
    virtual int getIslandTotalBridges(int row, int col) const = 0;
    virtual void setIslandValue(int row, int col, int value) = 0;
    virtual void setIslandBridgeByDir(int row, int col, int dir, int count) = 0;
